...
function startAppWithDeepLink(){
    createScript('http://192.168.0.104:9118/lampa-main/app.min.js?v' + Math.random(), function(){
...
function saveToLocal(){
    ...
    request.open('GET', 'http://192.168.0.104:9118/lampa-main/app.min.js?v' + Math.random());
    request.send();
}
...
function countdown() {
    if (timeLeft == 0) {
        ...
        checkConnection(
            'http://192.168.0.104:9118/lampa-main/app.min.js?v' + Math.random(),
            function () {
                clearTimeout(timerId);
